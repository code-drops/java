...
<%@ include file="sidebar.jsp" %>
    ...
    <%   
String s = (String)session.getAttribute("new_admin");
if(s == "true"){
  %>
...
<form action="includes/add_admin.jsp">
  <div class="container">
    <h1>Add Admin</h1>
    <hr>
    ...
    <input type="text" placeholder="Enter Address" name="address" require>
