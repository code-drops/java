...
<%@ include file="sidebar.jsp" %>
 <%   
String s = (String)session.getAttribute("new_student");
if(s == "true"){
  session.setAttribute("new_student",null);
  %>
<script type="text/javascript">
  ...
  <%
   ...
   %>
<script type="text/javascript">
  alert("New student added failed!");
</script>
...
%>
    <br><br>
<form action="includes/add_student.jsp">
  <div class="container">
    <h1>Add Student</h1>
    <hr>
    ...
    <input type="text" placeholder="YYYY-MM-DD" name="dob" required>
          ...
          <label for="parent_email"><b>Parent username</b></label>
    <input type="text" placeholder="Enter parent username" name="p_email" required>

    <label for="address"><b>Address</b></label>
    <input type="text" placeholder="Enter Address" name="address" required>

    <b>Gender :</b> <label class="radio-inline">
